/* ============================================================
   Harshit S K CTF  –  A 5-stage CLI capture-the-flag game
   Author: Harshit S K  |  Harshit S K
   ============================================================ */
...
(function () {
            ...
            handle: function (cmd) {
                ...
                if (cl.startsWith('cat')) {
                    ...
                    if (cl.includes('flag.txt') || cl.includes('/root/flag')) {
                        if (state._gotRoot) {
                            printBlank();
                            print('FLAG{connect_https://linkedin.com/in/harshitsk/}', 'flag');
                            printBlank();
                            print('[+] You\'ve captured the final flag!', 'success');
                            print('[+] Submit it: submit FLAG{connect_https://linkedin.com/in/harshitsk/}', 'system');
                            return;
                        } else {
                ...
                if (cl.includes('echo') && cl.includes('/tmp/exploit')) {
                    ...
                    if (cl.includes('shadow-backup')) {
                        ...
                        print('[+] Submit the flag: submit FLAG{connect_https://linkedin.com/in/harshitsk/}', 'system');
                    }
                    return;
                }
                ...
                if (cl.startsWith('submit ')) {
                    ...
                    if (answer === 'FLAG{connect_https://linkedin.com/in/harshitsk/}') {
                        printBlank();
                        print('[+] ██████████████████████████████████████', 'success');
                        print('[+] █                                    █', 'success');
                ...
                if (c === 'FLAG{connect_https://linkedin.com/in/harshitsk/}') {
                    printBlank();
                    print('[+] ██████████████████████████████████████', 'success');
                    print('[+] █     ALL STAGES COMPLETE!           █', 'success');
                    print('[+] █     FLAG CAPTURED SUCCESSFULLY     █', 'success');
    ...
    function showCompletion() {
        ...
        // Share URLs
        var shareText = 'I just completed the Harshit S K CTF on Harshit S K in ' + timeStr + ' with a rating of "' + rating + '"! Can you beat my time? 🏴';
        var siteUrl = 'https://www.linkedin.com/in/harshitsk/';
        var linkedinProfile = 'https://www.linkedin.com/in/harshitsk/';
    ...
    function startGame() {
        ...
        printLines([
            '┌─────────────────────────────────────────────────────────┐',
            '│  Harshit S K CTF v1.0 — ShadowNet Breach Simulation        │',
